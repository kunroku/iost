...
module.exports = class RAM {
    ...
    buy(payer, receiver, amount, tx = iost.createTx()) {
        ...
        this.iost.call(contract, 'buy', [payer, receiver, Number(amount)], tx);
        tx.addApprove('iost');
        return tx
    }
    /**
    ...
    sell(seller, receiver, amount, tx = iost.createTx()) {
        ...
        this.iost.call(contract, 'sell', [seller, receiver, Number(amount)], tx);
        return tx
    }
    /**
    ...
    lend(from, to, amount, tx = iost.createTx()) {
        ...
        this.iost.call(contract, 'lend', [from, to, Number(amount)], tx);
        return tx
    }
}