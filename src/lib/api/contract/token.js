...
module.exports = class Token {
    ...
    issue(tokenSym, to, amount, tx = iost.createTx()) {
        ...
        this.iost.call(contract, 'issue', [tokenSym, to, amount.toString()], tx);
        return tx
    }
    /**
     * Token transfer.
    ...
    transfer(tokenSym, from, to, amount, memo, tx = iost.createTx()) {
        ...
        this.iost.call(contract, 'transfer', [tokenSym, from, to, amount.toString(), memo], tx);
    ...
    transferFreeze(tokenSym, from, to, amount, ftime, memo, tx = iost.createTx()) {
        ...
        this.iost.call(contract, 'transferFreeze', [tokenSym, from, to, amount.toString(), ftime, memo], tx);
        tx.addApprove(tokenSym, amount.toString());
        return tx
    }
    /**
    ...
    destroy(tokenSym, from, amount, tx = iost.createTx()) {
        ...
        this.iost.call(contract, 'destroy', [tokenSym, from, amount.toString()], tx);
        tx.addApprove(tokenSym, amount.toString());
        return tx
    }
    /**
